...
typedef struct {
    ...
    // True if GHC was not passed -no-expand-response-files
...
extern void getResponseFilesArgv   ( int *argc, char **argv[] );
extern void setResponseFilesArgv    ( int argc, char *argv[] );
/* extern void freeResponseFilesArgv  ( void ) ; */
/* exit() override */
